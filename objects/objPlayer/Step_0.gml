...
Por iso vamos impedir que ele saia usano novamente  o place_mrrting()
Descrição no objBola.step lina 55
Ou seja, se colocarmos andarmos e bateros em uma parede iremo bloquear
*/
//Para ambos
